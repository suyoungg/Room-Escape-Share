...
namespace Room_Escape_by_VISIONARIES
{
    public partial class frmMain : Form
    {
        ...
        private void backgroundLock()                                             //Enable controls
        {
        ...
        /*If we make Beds color transparent, it displays backbuffer1. Instead of making picBeds transparent,
        beds_paint even will make picbeds display image of backbuffer2 where picbeds is located*/
        private void beds_paint(object sender, PaintEventArgs e)
        {
        ...
        private void beds_click(object sender, EventArgs e)                        //Click Event. When user click picpeds dialogue box appear
        {
            Dialogue();
        ...
        ////////////CUP AND TOWEL SWITCHED (LATER TO BE FIXED...)
